    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Revision Center</h1>
              ...
              {weakTopics.map((wt) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-4 rounded-xl border text-left transition flex items-start justify-between ${
                      isSelected
                  ...
                  >
                    <div>
                      ...
                      <h4 className="text-sm font-bold text-slate-900 mt-0.5">{wt.topic?.name}</h4>
            ...
            <div className="lg:col-span-2 space-y-6">
              {selectedTopic && (
                <>
                  ...
                  {/* Reassessment Quiz */}
                  <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                    ...
                    {topicAssessments.length > 0 ? (
                      <Link
                        ...
                        className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-xl transition flex items-center gap-2 shadow-sm whitespace-nowrap"
                      >
