...
export default function AchievementsPage() {
  ...
  useEffect(() => {
    async function loadAchievements() {
      ...
      // Catalog matching reference Screen 6
      const defaultBadgesList: BadgeItem[] = [
        ...
        },
        {
          ...
          code: 'SPEED_SOLVER',
          title: 'Speed Solver',
          description: 'Solve 10 in 5 mins',
          icon: 'Zap',
          criteria_type: 'speed_solve',
          criteria_value: 10,
          category: 'academics',
        },
        {
        ...
        },
        {
          ...
          description: 'Explored 5 subjects',
          icon: 'BookOpen',
          criteria_type: 'subject_explored',
          criteria_value: 5,
          category: 'progress',
        },
        {
          ...
          code: 'QUIZ_CHAMPION',
          title: 'Quiz Champion',
          description: 'Won 5 quizzes',
          icon: 'Trophy',
          criteria_type: 'quiz_won',
          criteria_value: 5,
          category: 'academics',
        },
        {
        ...
        },
        {
          ...
          icon: 'Lock',
          criteria_type: 'all_worlds_complete',
          criteria_value: 1,
          category: 'progress',
        },
      ];
