    ...
    <div className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3">
          <button
            ...
            className="min-h-[44px] px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-xl inline-flex items-center justify-center gap-1.5 transition shadow-sm"
          >
          ...
          <button
            ...
            className="min-h-[44px] px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold rounded-xl inline-flex items-center justify-center gap-1.5 transition shadow-sm"
          >
      ...
      {activeModal === 'assignment' && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center justify-center p-0 sm:p-4 backdrop-blur-xs">
          <div className="bg-white rounded-t-3xl sm:rounded-2xl p-5 sm:p-6 w-full max-w-lg shadow-xl border border-slate-100 max-h-[90vh] overflow-y-auto pb-safe">
            ...
            <form onSubmit={handleCreateAssignment} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full min-h-[44px] px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              ...
              <div className="pt-4 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="min-h-[44px] px-5 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white text-xs font-semibold rounded-xl inline-flex items-center justify-center gap-1.5 transition"
                >
            ...
            <form onSubmit={handleCreateLesson} className="space-y-4">
              ...
              <div className="pt-4 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="min-h-[44px] px-5 py-2 bg-slate-900 hover:bg-slate-800 disabled:opacity-60 text-white text-xs font-semibold rounded-xl inline-flex items-center justify-center gap-1.5 transition"
                >
                  {loading && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
